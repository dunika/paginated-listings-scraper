...
function getListings(_ref) {
  ...
  var maximiumDepth = _ref.maximiumDepth,
      ...
      otherOptions = (0, _objectWithoutProperties3.default)(_ref, ['maximiumDepth', 'origin', 'shouldReturnDataOnError', 'terminate']);
  ...
  var getListing = function () {
    var _ref2 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(requestOptions, _ref3) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 3:
              ...
              (0, _debug2.default)('Getting listings from ' + requestOptions.url);
              _context.next = 7;
            ...
            case 7:
              html = _context.sent;
              _context.next = 10;
              return (0, _extractData2.default)((0, _extends3.default)({ depth: depth, html: html, origin: origin, terminate: terminate }, otherOptions));
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 5;
            return getListings((0, _extends3.default)({ origin: origin }, otherOptions))((0, _extends3.default)({ url: url }, requestOptions));
