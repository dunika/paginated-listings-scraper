...
function getListings(_ref) {
  ...
  var getListing = function () {
    var _ref2 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(url) {
      ...
      var html, _ref3, nextPageUrl, data, nextData;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 10:
              ...
              _context.next = 16;
              return getListing(nextPageUrl, depth + 1);
...
exports.default = function () {
  var _ref4 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee2(options) {
    var url, otherOptions, _ref5, origin, data;
    ...
    return _regenerator2.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            url = options.url, otherOptions = (0, _objectWithoutProperties3.default)(options, ['url']);
            _ref5 = new _url.URL(url), origin = _ref5.origin;
            _context2.next = 5;
            return getListings((0, _extends3.default)({ origin: origin }, otherOptions))(url);
